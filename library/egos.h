...
#define APPS_VARG         0x80041000  /* 1KB    app main() argc, argv */
...
#define LOADER_VSTACK_BOTTOM   LOADER_VSTACK_TOP - (PAGE_SIZE * LOADER_VSTACK_NPAGES)
